...
/**
 * Based(nearly copy) on org.springframework.cloud.stream.binder.PartitionHandler but with partitionCount as parameter.
 */
public class KafkaPartitionHandler {
	 ...
	 * @since 3.0.2
	 */
	public KafkaPartitionHandler(EvaluationContext evaluationContext, ProducerProperties properties, ConfigurableListableBeanFactory beanFactory) {
