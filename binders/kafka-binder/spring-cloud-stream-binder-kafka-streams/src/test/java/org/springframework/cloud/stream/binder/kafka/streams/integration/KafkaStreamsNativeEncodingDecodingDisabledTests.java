...
class KafkaStreamsNativeEncodingDecodingDisabledTests {
	...
	@Test
	void nativeEncodingDecodingDisabled(EmbeddedKafkaBroker embeddedKafka) {
		...
		try (ConfigurableApplicationContext context = app.run("--server.port=0",
				...
				"--spring.cloud.stream.kafka.streams.bindings.process-in-0.consumer.applicationId=hello-NativeEncodingDecodingEnabledTests-xyz",
