...
public class KafkaBinderTests extends PartitionCapableBinderTests {
	...
	public void testCustomPartitionCountOverridesDefaultIfLarger() throws Exception {
		...
		producerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "10");
		Properties consumerProperties = new Properties();
		consumerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "10");
	...
	public void testCustomPartitionCountDoesNotOverrideModuleCountAndConcurrencyIfSmaller() throws Exception {
		...
		producerProps.put(CommonBinderProperties.MIN_PARTITION_COUNT, "5");
		producerProps.put(CommonBinderProperties.NEXT_MODULE_CONCURRENCY, "6");
		Properties consumerProps = new Properties();
		consumerProps.put(CommonBinderProperties.MIN_PARTITION_COUNT, "5");
		consumerProps.put(CommonBinderProperties.CONCURRENCY, "6");
		long uniqueBindingId = System.currentTimeMillis();
	...
	public void testCustomPartitionCountOverridesModuleCountAndConcurrencyIfLarger() throws Exception {
		...
		QueueChannel moduleInputChannel = new QueueChannel();
		Properties producerProps = new Properties();
		producerProps.put(CommonBinderProperties.MIN_PARTITION_COUNT, "6");
		producerProps.put(CommonBinderProperties.NEXT_MODULE_CONCURRENCY, "5");
		Properties consumerProps = new Properties();
		consumerProps.put(CommonBinderProperties.MIN_PARTITION_COUNT, "6");
		consumerProps.put(CommonBinderProperties.CONCURRENCY, "5");
		long uniqueBindingId = System.currentTimeMillis();
		binder.bindProducer("foo" + uniqueBindingId + ".0", moduleOutputChannel, producerProps);
		binder.bindConsumer("foo" + uniqueBindingId + ".0", moduleInputChannel, consumerProps);
		Message<?> message = org.springframework.integration.support.MessageBuilder.withPayload(ratherBigPayload).build();
	...
	public void testCustomPartitionCountDoesNotOverridePartitioningIfSmaller() throws Exception {
		...
		QueueChannel moduleInputChannel = new QueueChannel();
		Properties producerProperties = new Properties();
		producerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "3");
		producerProperties.put(CommonBinderProperties.NEXT_MODULE_COUNT, "5");
		producerProperties.put(CommonBinderProperties.PARTITION_KEY_EXPRESSION, "payload");
		Properties consumerProperties = new Properties();
		consumerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "3");
		long uniqueBindingId = System.currentTimeMillis();
		binder.bindProducer("foo" + uniqueBindingId + ".0", moduleOutputChannel, producerProperties);
		binder.bindConsumer("foo" + uniqueBindingId + ".0", moduleInputChannel, consumerProperties);
		Message<?> message = org.springframework.integration.support.MessageBuilder.withPayload(ratherBigPayload).build();
	...
	public void testCustomPartitionCountOverridesPartitioningIfLarger() throws Exception {
		...
		QueueChannel moduleInputChannel = new QueueChannel();
		Properties producerProperties = new Properties();
		producerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "5");
		producerProperties.put(CommonBinderProperties.NEXT_MODULE_COUNT, "3");
		producerProperties.put(CommonBinderProperties.PARTITION_KEY_EXPRESSION, "payload");
		Properties consumerProperties = new Properties();
		consumerProperties.put(CommonBinderProperties.MIN_PARTITION_COUNT, "5");
		long uniqueBindingId = System.currentTimeMillis();
		binder.bindProducer("foo" + uniqueBindingId + ".0", moduleOutputChannel, producerProperties);
		binder.bindConsumer("foo" + uniqueBindingId + ".0", moduleInputChannel, consumerProperties);
		Message<?> message = org.springframework.integration.support.MessageBuilder.withPayload(ratherBigPayload).build();
