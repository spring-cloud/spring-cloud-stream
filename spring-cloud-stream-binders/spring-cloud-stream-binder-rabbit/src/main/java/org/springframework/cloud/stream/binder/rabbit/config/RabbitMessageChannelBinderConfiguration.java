...
public class RabbitMessageChannelBinderConfiguration {
	@Autowired Codec codec;

	@Autowired ConnectionFactory rabbitConnectionFactory;
	
	@Autowired RabbitBinderConfigurationProperties rabbitBinderConfigurationProperties;
	
	@Autowired SpringRabbitMQProperties springRabbitMQProperties;
