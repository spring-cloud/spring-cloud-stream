...
Default values can be overridden by using the prefix `spring.cloud.stream.default`, e.g. `spring.cloud.stream.default.contentType=application/json`.
...
Default values can be overridden by using the prefix `spring.cloud.stream.default.consumer`, e.g. `spring.cloud.stream.default.consumer.headerMode=raw`.
...
Default values can be overridden by using the prefix `spring.cloud.stream.default.producer`, e.g. `spring.cloud.stream.default.producer.contentType=payload.id`.
