...
The default configuration will create a `DefaultSchemaRegistryClient` bean. If you want to use the confluent schema registry, you need to create a bean of that type
