...
As an example, You can refer link:https://github.com/spring-projects/spring-framework/blob/master/spring-messaging/src/main/java/org/springframework/messaging/converter/StringMessageConverter.java[String message converter].
...
Here is an example of creating a message converter bean inside the application:
...
public static class SinkApplication {
  ...
  @Bean
  public AbstractMessageConverter customMessageConverter() {
