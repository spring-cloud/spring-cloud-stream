...
package org.springframework.cloud.stream.support;
 ...
 * in the context to its own conversionService, so this is useful for binding properties of type Expression
 * in {@literal @}ConfigurationProperties annotated classes.
 *
 * @author Eric Bottard
 */
@Configuration
