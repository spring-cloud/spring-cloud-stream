...
* The directory `spring-cloud-stream-tools/src/main/resources/eclipse/` has two files for use with code formatting, `eclipse-code-formatter.xml` for the majority of the code formatting rules and `eclipse.importorder` to order the import statements.
