...
public interface ModuleDependencyRepository {
	 ...
	 */
	void store(String moduleName, String type, /* BaseDefinition? */String target);
	 ...
	 */
	Set</* BaseDefinition? */String> find(String name, String type);

	/**
	 * Remove an atomic dependency from a module (composed or not) to some target (stream, or composed module).
	 */
	void delete(String module, String type, /* BaseDefinition? */String target);
